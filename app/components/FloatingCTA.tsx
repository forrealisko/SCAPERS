                            ...
                            >
                                ...
                                <div className="p-2">
                                    <button
                                        ...
                                        className="w-full text-left block p-3 hover:bg-stone/10 rounded-xl transition-colors text-sm font-medium mb-1 text-forest"
                                    >
                                        Book a consultation
                                    </button>
                                    <a
                                        ...
                                        className="block p-3 hover:bg-stone/10 rounded-xl transition-colors text-sm font-medium mb-1 text-forest"
                                    >
                                        View Pricing
                                    </a>
                                </div>
