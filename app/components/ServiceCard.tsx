...
export default function ServiceCard({ title, description, icon, pricing, details }: ServiceCardProps) {
    ...
    return (
        ...
        >
            ...
            >
                {/* Front Side */}
                <div className="absolute inset-0 w-full h-full bg-black p-8 rounded-2xl border border-white/10 flex flex-col items-center justify-center text-center [backface-visibility:hidden]">
                    <motion.div
                ...
                {/* Back Side */}
                <div className="absolute inset-0 w-full h-full bg-forest p-8 rounded-2xl border border-white/20 flex flex-col text-left [backface-visibility:hidden] [transform:rotateY(180deg)]">
                    ...
                    <div className="space-y-3 mb-8 flex-grow">
                        {details.map((detail, i) => (
                            <div key={i} className="flex items-center gap-3 text-sm text-warm-white/70">
